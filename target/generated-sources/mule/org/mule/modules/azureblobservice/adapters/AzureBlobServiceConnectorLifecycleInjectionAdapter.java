...
/**
 * A <code>AzureBlobServiceConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AzureBlobServiceConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-10-28T06:31:11-07:00", comments = "Build UNNAMED.2613.77421cc")
public class AzureBlobServiceConnectorLifecycleInjectionAdapter
    extends AzureBlobServiceConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AzureBlobServiceConnectorLifecycleInjectionAdapter.class);
